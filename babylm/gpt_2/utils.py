...
def get_batch(split,args,model_type="GPT2"):
    ...
    if model_type == "GPT2_WML":
        y_one_hot = torch.zeros((args.train.batch_size, args.train.block_size, 50257), dtype=torch.float32, device=args.train.device)
